...
import FoodItemsTable from "../admin/FoodItemsTable";
...
const RestAdminDashBoard = () => {
  ...
  return (
    <Card className="container mx-auto p-10">
      <h1 className="text-2xl font-bold mb-6">Our Restaurant Dashboard</h1>
      ...
      >
        <TabsList className="grid w-full grid-cols-3 mb-6">
          <TabsTrigger value="users" className="flex items-center gap-2">
            <UserIcon size={16} /> Staff members
          </TabsTrigger>
...
export default RestAdminDashBoard;
